defmodule AuthAppWeb.SessionSignUpLive do
  ...
  def render(assigns) do
    ~H"""
      <.simple_form for={@form} phx-change="validate" action={~p"/auth/sign_in?_action=register"} method="post">
      ...
      <p class="mt-4 text-center text-sm text-gray-600">
        ...
        <.link
          navigate={Helpers.session_sign_in_path(@socket, :new)}
